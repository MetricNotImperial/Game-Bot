...
def checkBalls():
    ...
    if pyautogui.locateOnScreen('OutOfBalls.png') != None:
        while number2 == 0:
            ...
            if pyautogui.locateOnScreen('ZeroTing1.png', grayscale=True, confidence = 0.98) != None:
                time.sleep(np.random.uniform(0.1,0.4))
                pyautogui.keyDown("q")
                time.sleep(np.random.uniform(0.1,0.3))
                pyautogui.keyUp("q")
                
            if pyautogui.locateOnScreen('ZeroTing2.png', grayscale=True, confidence = 0.98) != None:
                time.sleep(np.random.uniform(0.1,0.4))
                pyautogui.keyDown("q")
                time.sleep(np.random.uniform(0.1,0.3))
                pyautogui.keyUp("q")
            ...
            if pyautogui.locateOnScreen('Welcome1.png', grayscale=True, confidence = 0.98) != None:
                time.sleep(np.random.uniform(0.1,0.4))
                pyautogui.keyDown("q")
                time.sleep(np.random.uniform(0.1,0.3))
                pyautogui.keyUp("q")
                
            if pyautogui.locateOnScreen('Welcome2.png', grayscale=True, confidence = 0.98) != None:
                time.sleep(np.random.uniform(0.1,0.4))
                pyautogui.keyDown("q")
                time.sleep(np.random.uniform(0.1,0.3))
                pyautogui.keyUp("q")
                
            if pyautogui.locateOnScreen('Welcome3.png', grayscale=True, confidence = 0.98) != None:
                time.sleep(np.random.uniform(0.1,0.4))
                pyautogui.keyDown("q")
                time.sleep(np.random.uniform(0.1,0.3))
                pyautogui.keyUp("q")
                
            if pyautogui.locateOnScreen('Welcome4.png', grayscale=True, confidence = 0.98) != None:
                time.sleep(np.random.uniform(0.1,0.4))
                pyautogui.keyDown("q")
                time.sleep(np.random.uniform(0.1,0.3))
                pyautogui.keyUp("q")
                
            if pyautogui.locateOnScreen('Welcome5.png', grayscale=True, confidence = 0.98) != None:
                time.sleep(np.random.uniform(0.1,0.4))
                pyautogui.keyDown("q")
                time.sleep(np.random.uniform(0.1,0.3))
                pyautogui.keyUp("q")
                
            if pyautogui.locateOnScreen('Welcome6.png', grayscale=True, confidence = 0.98) != None:
                time.sleep(np.random.uniform(0.1,0.4))
                pyautogui.keyDown("q")
                time.sleep(np.random.uniform(0.1,0.3))
                pyautogui.keyUp("q")
                
            if pyautogui.locateOnScreen('Welcome7.png', grayscale=True, confidence = 0.98) != None:
                time.sleep(np.random.uniform(0.1,0.4))
                pyautogui.keyDown("q")
                time.sleep(np.random.uniform(0.1,0.3))
                pyautogui.keyUp("q")
                
            if pyautogui.locateOnScreen('Welcome8.png', grayscale=True, confidence = 0.98) != None:
                time.sleep(np.random.uniform(0.1,0.4))
                pyautogui.keyDown("q")
                time.sleep(np.random.uniform(0.1,0.3))
                pyautogui.keyUp("q")
                
            if pyautogui.locateOnScreen('Welcome9.png', grayscale=True, confidence = 0.98) != None:
                time.sleep(np.random.uniform(0.1,0.4))
                pyautogui.keyDown("q")
                time.sleep(np.random.uniform(0.1,0.3))
                pyautogui.keyUp("q")
        ...
        #to make sure that i actually left the battle u know what im saying famlit
