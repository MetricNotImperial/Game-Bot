"""NOTES:FOR THIS CODE TO WORK ALIGN YOURSLEF AT THE LOCATION OF THE WATER BESIDE THE BUSH AND TOP LEFT OF THE SIGN, THE LETTER "Q"
SHOULD BE "A", THE LETTER "E" SHOULD BE "B" AND THE OLD ROD SHOULD BE HOT KEYED AS THE NUMBER "4"
"""
import pyautogui
...
while keyboard.is_pressed('o') == False:
    ...
    #checks if the ting didnt land
        ...
        #to wait for the white text to go away
        time.sleep(2)
    else:
